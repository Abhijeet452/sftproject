...
const About = () => {
  return (
    <>
      <nav className="navbar navbar-expand-lg navbar-light bg-light py-3" style={style}>
        <div className="container"><a href="/" className="navbar-brand d-flex align-items-center"> <i className="fa fa-snowflake-o fa-lg text-primary mr-2"></i><strong>PrimeInternship</strong></a>
        ...
        <div className="container py-5">
          <div className="row align-items-center mb-5">
            <div className="col-lg-6 order-2 order-lg-1"><i className="fa fa-bar-chart fa-2x mb-3 text-primary"></i>
              <h2 className="font-weight-light">PrimeInternship</h2>
              <p className="font-italic text-muted mb-4">A portal which offers employee/faculty to post internships accordingly and students to explore and apply to those internships. </p>
          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-6"><i className="fa fa-leaf fa-2x mb-3 text-primary"></i>
              <h2 className="font-weight-light">Technologies Used</h2>
              <p className="font-italic text-muted mb-4">MERN Stack<br /> M: MongoDB<br />E: Express<br />R:React<br /> N:NodeJs <br /></p><a href="https://www.mongodb.com/mern-stack" className="btn btn-light px-5 rounded-pill shadow-sm" target="_blank">Learn More</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="container py-5">
          ...
          <div className="row text-center">
            <div className="col-xl-2 col-sm-6 mb-5">
              <div className="bg-white rounded shadow-sm py-5 px-4"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT29CJPfcgQkwb_sZvjVTu9GueG__whgP2rN29uD1nkler5Id8M7VChq4xyssEImz3_T60&usqp=CAU" alt="" width="100" className="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm" />
                <h5 className="mb-0">Abhi Singh</h5><span className="small text-uppercase text-muted">Full Stack Developer</span>
                <ul className="social mb-0 list-inline mt-3 d-flex">
            ...
            <div className="col-xl-3 col-sm-6 mb-5">
              <div className="bg-white rounded shadow-sm py-5 px-4"><img src="https://bootstrapious.com/i/snippets/sn-about/avatar-3.png" alt="" width="100" className="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm" />
                <h5 className="mb-0">Rohan Singhvi</h5><span className="small text-uppercase text-muted">BackEnd Developer</span>
            ...
            <div className="col-xl-2 col-sm-6 mb-5">
              <div className="bg-white rounded shadow-sm py-5 px-4"><img src="https://bootstrapious.com/i/snippets/sn-about/avatar-2.png" alt="" width="100" className="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm" />
                <h5 className="mb-0">Anshuman Jain</h5><span className="small text-uppercase text-muted">FrontEnd Developer</span>
                <ul className="social mb-0 list-inline mt-3">
                  <li className="list-inline-item"><a href="#" className="social-link"><i className="fa fa-twitter"></i></a></li>
                  <li className="list-inline-item"><a href="#" className="social-link"><i className="fa fa-instagram"></i></a></li>
                  <li className="list-inline-item"><a href="#" className="social-link"><i className="fa fa-linkedin"></i></a></li>
            ...
            <div className="col-xl-3 col-sm-6 mb-5">
              <div className="bg-white rounded shadow-sm py-5 px-4"><img src="https://bootstrapious.com/i/snippets/sn-about/avatar-1.png" alt="" width="100" className="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm" />
                <h5 className="mb-0">Shreyans Jain</h5><span className="small text-uppercase text-muted">FrontEnd Developer</span>
                <ul className="social mb-0 list-inline mt-3">
                  <li className="list-inline-item"><a href="#" className="social-link"><i className="fa fa-twitter"></i></a></li>
                  <li className="list-inline-item"><a href="#" className="social-link"><i className="fa fa-instagram"></i></a></li>
                  <li className="list-inline-item"><a href="#" className="social-link"><i className="fa fa-linkedin"></i></a></li>
            ...
            <div className="col-xl-2 col-sm-6 mb-5">
              <div className="bg-white rounded shadow-sm py-5 px-4"><img src="https://bootstrapious.com/i/snippets/sn-about/avatar-1.png" alt="" width="100" className="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm" />
                <h5 className="mb-0">Rushil Patra</h5><span className="small text-uppercase text-muted">FrontEnd Developer</span>
                <ul className="social mb-0 list-inline mt-3">
                  <li className="list-inline-item"><a href="#" className="social-link"><i className="fa fa-twitter"></i></a></li>
                  <li className="list-inline-item"><a href="#" className="social-link"><i className="fa fa-instagram"></i></a></li>
                  <li className="list-inline-item"><a href="#" className="social-link"><i className="fa fa-linkedin"></i></a></li>
      ...
      <footer className="bg-light pb-5">
        <div className="container text-center">
          <p className="font-italic text-muted mb-0">&copy; Copyrights PrimeInternships <br/> All rights reserved.</p>
        </div>
      </footer>
    </>
  )
